...
class UserTest < ActiveSupport::TestCase
  ...
  context "user contexts" do
    ...
    should "Assure that user can only be added to an active employee" do
      ...
      @user = FactoryBot.build(:user, email:"user1@gmail.com", employee: @employee)
    ...
    should "make sure user_role function" do
      @employee = FactoryBot.build(:employee, first_name: "Shahmeer", last_name: "Ahmad", ssn: "123-67-8236", phone: "123-123-1234", role: "manager")
